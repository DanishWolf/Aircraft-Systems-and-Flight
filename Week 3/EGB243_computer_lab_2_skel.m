...
%% (Task 3) Simulation (Euler integration)
%TODO: Simulate the 3D trajectory based on the speed and angle vectors
% (hint: use a for-loop)
for i = 2:num_samples
...
%% (Task 4) Plotting My Attempt
%TODO: Plot the 3D (x,y,z) trajectory
...
f2 = figure(2); hold off
    clf; hold on
    yyaxis left    % Creates a plot with two y-axis
    plot(t,yaw);
    ylabel('Yaw (rad)');
  %  ylim([-200,800]);
    yyaxis right
